...
::::caution[Content Warnings 已弃用]
VRChat 官方公开提交文档写明，Content Warnings 目前已弃用且不再使用。即使旧面板或旧文档里还看得到相关字段，也不能把它当作免责机制：违反 Community Guidelines / ToS 的内容，无论有没有标记都会被处理。
::::
...
- [ ] Builder 扫一遍，所有 Android 兼容性问题已修：
  - 高成本或 PC 专用 Shader → 优先换成 `Mobile/VRChat/Lightmapped` 或 `VRChat/Mobile/...`
