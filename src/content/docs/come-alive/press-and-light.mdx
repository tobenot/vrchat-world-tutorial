...
requiresSDK: true
summary: 第四部的第一个动手章。在房间里放一个矮 Cube 当按钮，挂上一段五行的 UdonSharp，配一个 Box Collider 和一行提示文字，对物体发起 Interact 就能切换 Point Light 的开关。Interact 是 VRChat 一切按按钮交互的最小基本单位。
sidebar:
  order: 1
---
